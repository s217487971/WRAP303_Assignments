...
public class SOSGameBoard extends View {
    ...
    public SOSGameBoard(Context context, @Nullable AttributeSet attrs) {
        ...
        game = new GameLogic();
        //controller.publish(new calculator.Publisher(String.valueOf(player),"New Game"),"Game",null);
        lines = new ArrayList<>();
                ...
                if(game.getSOS()[row][col] == 0 && ClickedSymbol!=0)
                {
                    ...
                    if(game.insertSymbol(ClickedSymbol,row,col))
                    {
                        ...
                        if(ClickedSymbol==1)
                        {
                            ...
                            controller.publish( new calculator.Publisher(String.valueOf(player),"S Placed in Cell"),"S",null);
                        ...
                        else if(ClickedSymbol==2)
                        {
                            ...
                            controller.publish( new calculator.Publisher(String.valueOf(player),"O Placed in Cell"),"O",null);
                        }
    ...
    private void DrawPlayerOneLine(Canvas canvas, int row1, int col1, int row2, int col2, int player)
    {
        ...
        //controller.publish( new calculator.Publisher(String.valueOf(player),"SOS Completed"),"SOS",null);
