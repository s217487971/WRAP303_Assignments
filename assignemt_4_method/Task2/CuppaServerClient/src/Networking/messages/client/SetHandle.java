...
public class SetHandle extends Message<SubscriberClient> {
    ...
    public void apply(SubscriberClient subscriberClient) {
        ...
        if(Topics.customers.containsKey(handle))
        {
            handle = String.format("%s#%d", handle, subscriberClient.clientNum);
        }
        // Set the handle.
        ...
        Topics.subscribe(subscriberClient.handle, subscriberClient);
    }
}
